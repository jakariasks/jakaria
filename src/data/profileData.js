export const profile = {
  ...
  socials: {
    facebook: 'https://www.facebook.com/jakaria.sks',
    linkedin: 'https://www.linkedin.com/in/jakaria-sks/',
  ...
  resumes: {
    ...
    teaching: '/Jakaria_Hasan_Teaching_CV.pdf',
  },
}
...
export const whatIDo = [
  ...
  },
  {
    ...
    description: 'Teaching Science, ICT, and academic subjects to SSC, HSC, and admission-level students.',
  },
  {
    icon: 'Brain',
    title: 'Problem Solving',
    description: 'Practicing DSA, logical thinking, and coding challenges to improve programming skills.',
  },
  {
    icon: 'Layout',
    title: 'UI Planning',
    description: 'Designing clean user interfaces and planning user-friendly digital products.',
  },
  {
    icon: 'BookOpen',
    title: 'Academic Support',
    description: 'Helping students understand complex science and technology topics in an easy way.',
  },
]
